...
static esp_err_t status_page_handler(httpd_req_t *req) {
    const char html[] =
        ...
        "    .then(r => r.json())"
        "    .then(d => {"
        "      document.getElementById('val0').innerText = d.sensor_0.toFixed(3);"
        "      document.getElementById('val1').innerText = d.sensor_1.toFixed(3);"
        "      document.getElementById('val2').innerText = d.sensor_2.toFixed(3);"
        "      document.getElementById('val3').innerText = d.sensor_3.toFixed(3);"
        "      document.getElementById('val4').innerText = d.sensor_4.toFixed(3);"
        "      document.getElementById('val5').innerText = d.sensor_5.toFixed(3);"
        "      document.getElementById('val6').innerText = d.sensor_6.toFixed(3);"
        "    });"
        "}, 500);"
        "</script>"
