...
Access streamed camera feed at: http://10.0.0.104/
Access live update sensor data at: http://10.0.0.104/adc_value

Run PollSensor.py after ESP32-CAM is running to trigger camera capture at threshold
When running Python script you cannot also have the live browser stream